...
const Avatar = ({ src, name }: AvatarProps) => {
  return (
    <div
      ...
      className="group -ml-2 flex shrink-0 place-content-center relative border-4 border-white rounded-full bg-neutral-800"
    >
      ...
      {src ? (
        ...
        <span className="text-white text-xs font-semibold m-auto">
          {name?.[0]?.toUpperCase() ?? "?"}
        </span>
      )}
    </div>
